...
invalid_inputs = [
        ...
        ([1, "two", 3], ValueError, "All elements in the list must be integers or floats"),
...
correctness_check_inputs =[
        ...
        ([5, 3, 8, 6, 2], [2, 3, 5, 6, 8]),  # Small unsorted list with more elements
        ...
        ([-1, -5, -7, 9, 2, -29], [-29, -7, -5, -1, 2, 9]) #List with negative numbers 
    ]

corner_case_inputs = [
        ([1000000, 1, -1000000, 0, 999999], [-1000000, 0, 1, 999999, 1000000]),  # List with large positive and negative numbers
        ([-1, -5, -3, -2], [-5, -3, -2, -1]),  # List with all negative numbers
        ([1.5, 2.3, -0.7, -2.2, 0.0], [-2.2, -0.7, 0.0, 1.5, 2.3]),  # List with negative floats
        ([], []),  # Empty list
